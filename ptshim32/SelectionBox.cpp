...
CSelectionBox::CSelectionBox(std::set<cPassThruInfo> &connectedList, CWnd *pParent /*=NULL*/)
    : CDialog(CSelectionBox::IDD, pParent)
...
void
CSelectionBox::DoDataExchange(CDataExchange *pDX)
{
...
CSelectionBox::OnInitDialog()
{
	...
	CString cstrPath;
	cstrPath.Format(_T("%s\\%s_%04d-%02d-%02d_%02d-%02d-%02d_%04d.txt"), szPath, _T("ShimDLL"), LocalTime.wYear, LocalTime.wMonth, LocalTime.wDay,
...
// serial number
static int CALLBACK
CompareByName(LPARAM lParam1, LPARAM lParam2, LPARAM lParamSort)
{
...
void
CSelectionBox::DoPopulateRegistryListbox()
{
...
void
CSelectionBox::OnLvnItemchangedList1(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void
CSelectionBox::OnHdnItemdblclickList1(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void
CSelectionBox::OnBnClickedConfig()
{
	POSITION pos = m_listview.GetFirstSelectedItemPosition();
	if (pos == NULL)
		return;
...
void
CSelectionBox::OnBnClickedBrowse()
{
...
cPassThruInfo *
CSelectionBox::GetSelectedPassThru()
{
	return sel;
}

CString
CSelectionBox::GetDebugFilename()
{
